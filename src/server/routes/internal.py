...
_AGENT_COMMUNICATION_FILE = Path(__file__).resolve().parents[3] / "assets" / "prompts" / "agent_communication.md"
...
async def ask_agent(
    ...
    try:
        stream = bridge.run_stream(
            ...
            extra_system_prompt_file=extra_prompt_file,
